-- ============================================
-- RINNOVATI INSTITUTE — Esquema de Base de Datos
-- Ejecutar en phpMyAdmin o MySQL Workbench
-- ============================================

CREATE DATABASE IF NOT EXISTS rinnovat_rinnovati
  CHARACTER SET utf8mb4
  COLLATE utf8mb4_unicode_ci;

USE rinnovat_rinnovati;
...
CREATE TABLE IF NOT EXISTS registros (
  ...
  -- Card 3: Certificación Profesional
